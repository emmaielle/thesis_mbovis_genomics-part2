## 3.trimANDfilterReads_orFullGenomes.sh
...
Usage: ```bash <3.trimANDfilterReads_orFullGenomes.sh> qs cov folder1 [folder2 .. folderN]```

Example: ```bash 3.trimANDfilterReads_orFullGenomes.sh 20 30 *```
