...
parser = argparse.ArgumentParser(description="Parse string to adjust to plotTree.py colour format. Separator: space")
parser.add_argument(dest="input", type=str, nargs=1, metavar="str", help="String space-separated")
...
def setup():
    ...
    string = arguments.input[0]
    ids = string.split(' ')      
    
    parseString(ids)

def parseString(array):
    arrayOut = []
    ...
    colours_50 = ["Red", "DarkBlue", "Gold", "LimeGreen","Violet","MediumTurquoise","Sienna","LightCoral","LightSkyBlue","Indigo","Tan","Coral","OliveDrab","Teal", "#E41A1C","#C72A35","#AB3A4E","#8F4A68","#735B81","#566B9B","#3A7BB4","#3A85A8","#3D8D96","#419584", "#FF8904","#FF9E0C","#FFB314","#FFC81D","#FFDD25","#FFF12D","#F9F432","#EBD930","#DCBD2E"]
